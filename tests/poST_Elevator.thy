...
"Elevator = 
  ...
  [(''Controller'',
    [(prog_var.InVar 
      ( 
        [(''onfloor0'',var_init_decl.Symbolic (ptype.Bool False) None),
         (''onfloor1'',var_init_decl.Symbolic (ptype.Bool False) None),
         (''onfloor2'',var_init_decl.Symbolic (ptype.Bool False) None),
         (''call0'',var_init_decl.Symbolic (ptype.Bool False) None),
         (''call1'',var_init_decl.Symbolic (ptype.Bool False) None),
         (''call2'',var_init_decl.Symbolic (ptype.Bool False) None),
         (''button0'',var_init_decl.Symbolic (ptype.Bool False) None),
         (''button1'',var_init_decl.Symbolic (ptype.Bool False) None),
         (''button2'',var_init_decl.Symbolic (ptype.Bool False) None),
         (''door0closed'',var_init_decl.Symbolic (ptype.Bool False) None),
         (''door1closed'',var_init_decl.Symbolic (ptype.Bool False) None),
         (''door2closed'',var_init_decl.Symbolic (ptype.Bool False) None)])),
     (prog_var.OutVar 
      ( 
        [(''up'',var_init_decl.Symbolic (ptype.Bool False) None),
         (''down'',var_init_decl.Symbolic (ptype.Bool False) None),
         (''open0'',var_init_decl.Symbolic (ptype.Bool False) None),
         (''open1'',var_init_decl.Symbolic (ptype.Bool False) None),
         (''open2'',var_init_decl.Symbolic (ptype.Bool False) None),
         (''call0_LED'',var_init_decl.Symbolic (ptype.Bool False) None),
         (''call1_LED'',var_init_decl.Symbolic (ptype.Bool False) None),
         (''call2_LED'',var_init_decl.Symbolic (ptype.Bool False) None),
         (''button0_LED'',var_init_decl.Symbolic (ptype.Bool False) None),
         (''button1_LED'',var_init_decl.Symbolic (ptype.Bool False) None),
         (''button2_LED'',var_init_decl.Symbolic (ptype.Bool False) None),
         (''floor0_LED'',var_init_decl.Symbolic (ptype.Bool False) None),
         (''floor1_LED'',var_init_decl.Symbolic (ptype.Bool False) None),
         (''floor2_LED'',var_init_decl.Symbolic (ptype.Bool False) None),
         (''cur'',var_init_decl.Symbolic (ptype.Int 0) None)])),
     (prog_var.Var (False, 
      ( 
        [(''target'',var_init_decl.Symbolic (ptype.Int 0) None)])))],
    [(''Init'',
      [],
      [(''begin'',
        False,
     ...
     (''Call0Latch'',
      [(proc_var.Var (False,
        ([(''prev_in'',var_init_decl.Symbolic (ptype.Bool False) None),
           (''prev_out'',var_init_decl.Symbolic (ptype.Bool False) None)])))],
      [(''init'',
        False,
