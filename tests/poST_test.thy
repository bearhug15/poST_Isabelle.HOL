	...
	(None,
	 [(False, 
	 	[(''var1'', (all_var_init_decl.Var 
	 		(var_init_decl.Symbolic (ptype.Int 0) (Some (expr.Const (const.Int (-5))))))),
	 	(''var1'', (all_var_init_decl.GlobalVar ((direct_type_perfix.I, direct_size_prefix.D, [(10), (10)]), (ptype.Int 0))))])],
