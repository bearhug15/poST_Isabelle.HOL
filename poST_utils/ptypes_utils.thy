...
definition ptype_to_bptint :: "ptype \<Rightarrow> ptype" where
  "ptype_to_bptint value = 
    (case value of 
...
declare ptype_to_bptint_def [simp]
...
definition ptype_to_Bool :: "ptype \<Rightarrow> ptype" where
"ptype_to_Bool var = (case var of
  (ptype.Nat val) \<Rightarrow> (ptype.Bool (if val > 0 then True else False)) |
  (ptype.Int val) \<Rightarrow> (ptype.Bool (if val \<noteq> 0 then True else False)) |
  (ptype.Real val) \<Rightarrow> (ptype.Bool (if val \<noteq> 0 then True else False)) | 
  (ptype.Time val) \<Rightarrow> (ptype.Bool (\<not> (time_eq val (time.Time 0 0 0 0 0)))) |
  (ptype.Bool val) \<Rightarrow> (ptype.Bool val))"
declare ptype_to_Bool_def [simp]

definition ptype_to_bool :: "ptype \<Rightarrow> bool" where
"ptype_to_bool var = (case var of
  (ptype.Nat val) \<Rightarrow>  (if val > 0 then True else False) |
  (ptype.Int val) \<Rightarrow> (if val \<noteq> 0 then True else False) |
  (ptype.Real val) \<Rightarrow>  (if val \<noteq> 0 then True else False) | 
  (ptype.Time val) \<Rightarrow>  (\<not> (time_eq val (time.Time 0 0 0 0 0))) |
  (ptype.Bool val) \<Rightarrow>  val)"
declare ptype_to_bool_def [simp]

definition ptype_sum :: "ptype \<Rightarrow> ptype \<Rightarrow> ptype" where
  "ptype_sum var1 var2 = (case (var1,var2) of
    ...
    ((ptype.Byte var1),(ptype.Byte var2)) \<Rightarrow> ptype.Byte (byte_sum var1 var2) |
...
(*
((ptype.Bool var1 ),(ptype.Bool var2)) \<Rightarrow> ptype.Bool (xor var1 var2) |
((ptype.Time var1),(ptype.Time var2)) \<Rightarrow> ptype.Time (time_sum var1 var2) |
*)
definition ptype_sub :: "ptype \<Rightarrow> ptype \<Rightarrow> ptype" where
  "ptype_sub var1 var2 = (case (var1,var2) of
    ((ptype.Nat var1),(ptype.Nat var2)) \<Rightarrow> ptype.Nat (var1 - var2) |
    ((ptype.Int var1),(ptype.Int var2)) \<Rightarrow> ptype.Int (var1 - var2) |
    ((ptype.Real var1),(ptype.Real var2)) \<Rightarrow> ptype.Real (var1 - var2) |
    
    ((ptype.Byte var1),(ptype.Byte var2)) \<Rightarrow> ptype.Byte (byte_sub var1 var2) |
...
definition ptype_mul :: "ptype \<Rightarrow> ptype \<Rightarrow> ptype" where
  "ptype_mul var1 var2 = (case (var1,var2) of
    ((ptype.Nat var1),(ptype.Nat var2)) \<Rightarrow> ptype.Nat (var1 * var2) |
    ((ptype.Int var1),(ptype.Int var2)) \<Rightarrow> ptype.Int (var1 * var2) |
    ((ptype.Real var1),(ptype.Real var2)) \<Rightarrow> ptype.Real (var1 * var2) |
    
    ((ptype.Byte var1),(ptype.Byte var2)) \<Rightarrow> ptype.Byte (byte_mul var1 var2) |
...
definition ptype_div :: "ptype \<Rightarrow> ptype \<Rightarrow> ptype" where
  "ptype_div var1 var2 = (case (var1,var2) of
    ...
    ((ptype.Real var1),(ptype.Real var2)) \<Rightarrow> ptype.Real (var1 div var2) |
    
    ((ptype.Byte var1),(ptype.Byte var2)) \<Rightarrow> ptype.Byte (byte_divide var1 var2) |
...
definition ptype_mod :: "ptype \<Rightarrow> ptype \<Rightarrow> ptype" where
  "ptype_mod var1 var2 = (case (var1,var2) of
    ...
    ((ptype.Byte var1),(ptype.Byte var2)) \<Rightarrow> ptype.Byte (byte_mod var1 var2) |
...
"ptype_not var = (let res = ptype_to_Bool var in
  (case res of (ptype.Bool val) \<Rightarrow> (ptype.Bool val) ))"
declare ptype_not_def [simp]

definition ptype_eq :: "ptype \<Rightarrow> ptype \<Rightarrow> bool" where
  "ptype_eq var1 var2 = (case (var1,var2) of 
    ...
    ((ptype.Nat var1),(ptype.Real var2)) \<Rightarrow> (real var1) = var2 |
    ((ptype.Real var1),(ptype.Nat var2)) \<Rightarrow> var1 = (real var2) |
...
definition ptype_less :: "ptype \<Rightarrow> ptype \<Rightarrow> bool" where
  "ptype_less var1 var2 = (case (var1,var2) of 
    ((ptype.Nat var1),(ptype.Nat var2)) \<Rightarrow> var1 < var2 |
    ((ptype.Int var1),(ptype.Int var2)) \<Rightarrow> var1 < var2 |
    ((ptype.Real var1),(ptype.Real var2)) \<Rightarrow> var1 < var2 |
...
definition ptype_more :: "ptype \<Rightarrow> ptype \<Rightarrow> bool" where
  "ptype_more var1 var2 = (case (var1,var2) of 
    ((ptype.Nat var1),(ptype.Nat var2)) \<Rightarrow> var1 > var2 |
    ((ptype.Int var1),(ptype.Int var2)) \<Rightarrow> var1 > var2 |
    ((ptype.Real var1),(ptype.Real var2)) \<Rightarrow> var1 > var2 |
...
definition ptype_lesseq :: "ptype \<Rightarrow> ptype \<Rightarrow> bool" where
  "ptype_lesseq var1 var2 = (case (var1,var2) of 
    ...
    (_,_) \<Rightarrow> False )"
declare ptype_lesseq_def [simp]

definition const_basic_lesseq :: "const \<Rightarrow> ptype \<Rightarrow> bool" where 
"const_basic_lesseq c var = ptype_lesseq (const_to_basic c) var"
declare const_basic_lesseq_def [simp]

definition basic_const_lesseq :: "ptype \<Rightarrow> const \<Rightarrow> bool" where 
"basic_const_lesseq var c = ptype_lesseq var (const_to_basic c)"
declare basic_const_lesseq_def [simp]

definition ptype_moreeq :: "ptype \<Rightarrow> ptype \<Rightarrow> bool" where
  "ptype_moreeq var1 var2 = (case (var1,var2) of 
    ...
    (_,_) \<Rightarrow> False )"
declare ptype_moreeq_def [simp]

definition const_basic_moreeq :: "const \<Rightarrow> ptype \<Rightarrow> bool" where 
"const_basic_moreeq c var = ptype_moreeq (const_to_basic c) var"
declare const_basic_moreeq_def [simp]

definition basic_const_moreeq :: "ptype \<Rightarrow> const \<Rightarrow> bool" where 
"basic_const_moreeq var c = ptype_moreeq var (const_to_basic c)"
declare basic_const_moreeq_def [simp]

definition ptype_noteq :: "ptype \<Rightarrow> ptype \<Rightarrow> bool" where
  "ptype_noteq var1 var2 = (case (var1,var2) of 
...
definition ptype_and :: "ptype \<Rightarrow> ptype \<Rightarrow> bool" where
  "ptype_and var1 var2 = (case (var1,var2) of 
    ((ptype.Bool var1),(ptype.Bool var2)) \<Rightarrow> var1 \<and> var2 |
    (_,_) \<Rightarrow> False )"
...
definition ptype_or :: "ptype \<Rightarrow> ptype \<Rightarrow> bool" where
  "ptype_or var1 var2 = (case (var1,var2) of 
    ((ptype.Bool var1),(ptype.Bool var2)) \<Rightarrow> var1 \<or> var2 |
    (_,_) \<Rightarrow> False )"
...
definition ptype_xor :: "ptype \<Rightarrow> ptype \<Rightarrow> bool" where
  "ptype_xor var1 var2 = (case (var1,var2) of 
    ((ptype.Bool var1),(ptype.Bool var2)) \<Rightarrow> var1 \<noteq> var2 |
    (_,_) \<Rightarrow> False )"
